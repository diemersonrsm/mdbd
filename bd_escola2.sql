...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/09/2026 às 14:16
...
INSERT INTO `coordenadores` (`ID_Coordenador`, `Formacao`, `ID_Info`, `Status`) VALUES
...
INSERT INTO `cursos` (`ID_Curso`, `Nome_Curso`, `Carga_Horaria`, `Duracao`, `Descricao`, `Status`) VALUES
...
INSERT INTO `disciplinas` (`ID_Disciplina`, `Carga_Horaria`, `ProfessorResp`, `nome_da_disciplina`, `Status`) VALUES
...
INSERT INTO `formacoes` (`ID_Formacao`, `Descricao`, `Status`) VALUES
(1, 'Doutorado', ''),
(2, 'Mestrado', ''),
(3, 'Especialização', '');
...
INSERT INTO `matriculas` (`ID_Matricula`, `Data_de_Matricula`, `Situação`, `Status`) VALUES
(1, '2026-06-12', 1, ''),
(2, '2026-06-12', 1, ''),
(3, '2026-06-12', 3, ''),
(4, '2026-06-12', 3, ''),
...
INSERT INTO `professores` (`ID_Professor`, `Nome`, `ID_Info`, `ID_Formacao`, `Status`) VALUES
